...
G1=nx.Graph()
G1=nx.read_edgelist(DS[1])
#G1.add_edges_from(e_LITR)

  
##Quito los auto-loops
lista_enlaces=list(G1.edges())

for enlace in lista_enlaces:
    if enlace[0]==enlace[1]:
        G1.remove_edge(enlace[0],enlace[1])
...
proba_nodo_esencial_k1=[1-((1-beta_redes[1])*(1-alfa_redes[1])**k) for k in lista_grados]
...
for pares in pares_nodos_no_ady_entre_si1:
    if par[0]==par[1]:
        print("ACA")
