...
G=nx.read_edgelist("yeast_AP-MS.txt")
...
plt.xlabel("Grado (k)")
plt.ylabel("Ln(1-PE)")
plt.title("Relación entre la probabilidad de un nodo de ser esencial y su grado (k), red AP-MS")
plt.plot(x, y, "*", x, fitfunc(p1, x), "k-", linewidth=1)
plt.plot(x, fitfunc(p1, x), "k-", label = "Ln(1-PE)=-0,0636 k-0,1844")
plt.legend()
